...
gcc -Iheader "$(pkg-config --cflags --static gtk+-3.0)" -o tictactoe src/main.c src/minimax.c src/importData.c src/ml-naive-bayes.c src/elapsedTime.c "$(pkg-config --libs --static gtk+-3.0)"
